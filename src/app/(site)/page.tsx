        ...
        >
          {[...Array(2)].map((arr) => (
            <div
              key={arr}
              className='
          flex flex-nowrap animate-slide'
            >
              {CLIENTS.map((client) => (
                <div
                  key={client.alt}
                ...
                >
                  <Image
                    ...
                    alt={client.alt}
                    width={200}
                    className='objet-contain max-w-none'
                  />
                </div>
              ))}
            </div>
            ...
            return (
              ...
              >
                {USERS.map((testimonial, index) => {
                  return (
                    <CustomCard
                      className='w-[500px] shrink-0 rounded-xl dark:bg-gradient-to-t dark
